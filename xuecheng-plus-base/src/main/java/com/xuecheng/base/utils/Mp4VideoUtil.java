...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "E:\\学成在线\\day01 项目介绍&环境搭建\\资料\\常用软件工具\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
...
//        Process p = builder.start();
        ...
        String ffmpeg_path = "E:\\学成在线\\day01 项目介绍&环境搭建\\资料\\常用软件工具\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "C:\\Users\\吾空白\\Videos\\Captures\\1.mp4";
        //转换后mp4文件的名称
        String mp4_name = "02-概述-分库分表是什么.avi";
        //转换后mp4文件的路径
        String mp4_path = "D:\\02-概述-分库分表是什么.avi";
        //创建工具类对象
